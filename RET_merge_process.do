...
by x01: replace Sbirth_y = Sbirth_y[_n-`a'] if Sbirth_y==-999 & Sbirth_y[_n-`a'] !=. & Sbirth_y[_n-`a'] !=-999
...
by x01: replace Sretire_y = Sretire_y[_n-`a'] if Sretire_y==. & Sretire_y[_n-`a'] !=.
by x01: replace Sretire_y = Sretire_y[_n+`a'] if Sretire_y==. & Sretire_y[_n+`a'] !=.
